...
BASE_LOGS_DIR = Path.home() / ".config" / "flouri" / "logs"
...
def initialize_session_log() -> Path:
    ...
    session_start = {
        ...
        "event": "session_start",
        "message": "Flouri session started",
    }
...
def _setup_conversation_logger() -> logging.Logger:
    ...
    # Create logger
    logger = logging.getLogger("flouri.conversation")
...
def _setup_terminal_logger() -> logging.Logger:
    ...
    # Create logger
    logger = logging.getLogger("flouri.terminal")
    logger.setLevel(logging.INFO)
